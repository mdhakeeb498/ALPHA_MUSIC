...
def stream_markup_timer(_, chat_id, played, dur):
    ...
    buttons = [
      ...
      [
            InlineKeyboardButton(
                text="𝖮ᴡɴᴇʀ 🥀", url="https://t.me/llMR_VAMPIRE_KINGll",
            ),
            InlineKeyboardButton(
                text="𝖲ᴜᴘᴘᴏʀᴛ 🥀", url="https://t.me/FCC_OFICIAL",
            )
        ],
...
def stream_markup(_, chat_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="𝖮𝗐𝗇𝖾𝗋🥀", url="https://t.me/llMR_VAMPIRE_KINGll",
            ),
            InlineKeyboardButton(
                text="𝖲𝗎𝗉𝗉𝗈𝗋𝗍🥀", url="https://t.me/FCC_OFICIAL",
            )
        ],
        [InlineKeyboardButton(text=_["CLOSE_BUTTON"], callback_data="close")],
    ]
